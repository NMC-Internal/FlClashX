...
abstract class $AuthSessionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String email, String subscriptionUrl});
}
...
class _$AuthSessionImpl implements _AuthSession {
  const _$AuthSessionImpl(
      {required this.token, this.email = "", this.subscriptionUrl = ""});
  ...
  @override
  String toString() {
    return 'AuthSession(token: $token, email: $email, subscriptionUrl: $subscriptionUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, email, subscriptionUrl);
...
abstract class _AuthSession implements AuthSession {
  const factory _AuthSession(
      ...
      final String email,
      final String subscriptionUrl}) = _$AuthSessionImpl;
